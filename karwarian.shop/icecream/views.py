...
# Frontend page views
def icecream_home(request):
    """Ice cream homepage"""
    return render(request, 'icecream/index.html')


def icecream_products(request):
    """Products listing page"""
    return render(request, 'icecream/products.html')


def icecream_cup(request):
    return render(request, 'icecream/cup.html')


def icecream_cone(request):
    return render(request, 'icecream/cone.html')


def icecream_chocobar(request):
    return render(request, 'icecream/chocobar.html')


def icecream_kulfi(request):
    return render(request, 'icecream/kulfi.html')


def icecream_gadbad(request):
    return render(request, 'icecream/gadbad.html')


def icecream_cart(request):
    return render(request, 'icecream/cart.html')


def icecream_payment(request):
    return render(request, 'icecream/payment.html')
...
def admin_login_view(request):
    ...
    if request.session.get('is_admin'):
        return redirect('icecream_admin_dashboard')
    return render(request, 'icecream/admin_login.html')
...
def admin_logout_view(request):
    ...
    return redirect('icecream_admin_login')
...
def admin_dashboard_view(request):
    ...
    return render(request, 'icecream/admin_dashboard.html', context)
...
def pending_orders_view(request):
    ...
    return render(request, 'icecream/pending_orders.html', context)
...
def confirmed_orders_view(request):
    ...
    return render(request, 'icecream/confirmed_orders.html', context)


def out_for_delivery_view(request):
    """Out for delivery orders page"""
    if not request.session.get('is_admin'):
        return redirect('icecream_admin_login')
    ...
    return render(request, 'icecream/out_for_delivery.html', context)
...
def delivered_orders_view(request):
    ...
    return render(request, 'icecream/delivered_orders.html', context)
